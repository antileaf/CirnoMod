...
public class CirnoDiscardPileToHandAction extends AbstractGameAction {
	
	public static final String[] TEXT = CardCrawlGame.languagePack
			.getUIString("CirnoDiscardPileToHandAction").TEXT;
	private AbstractPlayer p;
	
	public CirnoDiscardPileToHandAction(int amount) {
